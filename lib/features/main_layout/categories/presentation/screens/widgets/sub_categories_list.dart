...
import 'package:ecommerce_app/features/main_layout/categories/presentation/screens/widgets/category_card_item.dart';
              ...
              delegate: SliverChildBuilderDelegate(
                childCount: subCategories?.data?.length??0,
                    (context, index) => InkWell(
                      onTap: (){
                        Navigator.pushNamed(context, Routes.productScreenRoute,arguments: subCategories?.data?[index].catId);
                      },
